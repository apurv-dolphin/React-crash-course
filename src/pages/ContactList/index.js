    ...
    <>
      ...
      <div className="row">
        <div className="col text-center">
          ...
          <p>
            This demo performs CRUD operation in redux store. You can add, edit
            and delete a contact in the below demo
          </p>
            ...
            <div className="card">
              ...
              <ul className="list-group list-group-flush">
                {contacts.map((contact, index) => (
                  <ContactCard {...contact} index={index} key={contact.name} />
                ))}
              </ul>
            </div>
          </div>
