      ...
      <div className="row w-100">
        ...
        <div className="alert alert-danger" role="alert">
          <h4 className="alert-heading">
            Sorry!!! Demo will not work properly due to google's billing
            restriction
          </h4>
          <p>
            ...
            and use your own google map API key to check the demo. Update your
            google API key in <strong>src/App.config.js</strong> after cloning
            the repository
          </p>
        </div>
