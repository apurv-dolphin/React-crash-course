...
const HooksDemo = () => {
  ...
  return (
    <>
      ...
      <div className="separator">Hook 1: Unsaved changes warning Hook</div>
        ...
        <div className="col-lg-6 text-center ">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div>
                Type something in the box below and move to other screen without
                submitting
              </div>
      ...
      <div className="separator">Hook 2: Visiblity Toggler Hook</div>
